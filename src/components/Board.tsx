  ...
  return (
    <>
      <section className="w-full h-full bg-cover relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 h-[calc(100vh-8rem)] w-full">
          <div
            id="board-header"
            className="w-full h-13 flex items-center justify-between p-4 bg-slate-800 bg-opacity-70 text-primary-foreground"
          >
          ...
          >
            ...
            <DialogAddList boardId={board.id}>
              <div
                id="add-list"
                className="min-w-52 h-fit bg-slate-800 hover:opacity-80 rounded-lg p-4 flex justify-between text-primary-foreground cursor-pointer gap-2"
              >
